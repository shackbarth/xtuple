  ...
  X.reportRoute = X.Route.create({
    ...
    handle: function (xtr) {
      ...
      session.once("isReady", function () {
        ...
        requestDetails.username = session.username;
