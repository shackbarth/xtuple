...
(function () {
  ...
  utils.pause(2000, function () {
  browser.elementByXPath(contactObj.Obj.caccount1_xpath, function (err,el15a){
  browser.click(el15a, function() {
  ...
  utils.pause(1000,function () {
  browser.elementByXPath(contactObj.Obj.cowner1_xpath, function (err, el16a){
  browser.click(el16a, function() {
  utils.pause(1000, function () {
  ...
  utils.pause(4000,function () {
  browser.waitForElementByXPath(contactObj.readObj1.searchField_xpath, 5000, function () {
