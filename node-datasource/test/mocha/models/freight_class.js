...
describe('FreightClass CRUD Test', function(){
  ...
  it('should create an XM.FreightClass Model', function(){
  ...
  it('should update an XM.FreightClass Model', function(){
    data.model.set(data.updateHash);
    crud.save(data)
    assert.equal(data.model.get('code'), data.updateHash.code, 'Model Code UPDATE Value is equal')
  });

  it('should delete an XM.FreightClass Model', function(){
    crud.destroy(data)
  });
