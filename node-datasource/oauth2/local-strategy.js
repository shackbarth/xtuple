...
function Strategy(options, verify) {
  ...
  this._databaseField = options.databaseField || 'database';
...
Strategy.prototype.authenticate = function (req, options) {
  ...
  var database = lookup(req.body, this._databaseField) || lookup(req.query, this._databaseField);
  ...
  if (self._passReqToCallback) {
    this._verify(req, username, password, database, verified);
  } else {
    this._verify(username, password, database, verified);
  }
