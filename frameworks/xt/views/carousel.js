...
*/
XT.Carousel = SC.CompositeSurface.extend({
  ...
  makeSurfaceVisible: function(surface) {
    ...
    if (idx === -1) {
      console.log('XT.Carousel#makeSurfaceVisible: surface is not a subsurface of our tray.');
      return;
    } else {
  ...
  initTray: function() {
    var tray;
    tray = this._sc_tray = XT.InternalCarouselTray.create();
...
XT.InternalCarouselTray = SC.CompositeSurface.extend({
  ...
  updateLayout: function() {
    // console.log('XT.InternalCarouselTray#updateLayout()');
