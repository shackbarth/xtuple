...
*/
XT.TileCarousel = XT.Carousel.extend({

  _sc_backgroundColor: 'black',

  updateTrayLayout: function() {
    // console.log('XT.TileCarousel#updateTrayLayout()');
  ...
  initTray: function() {
    var tray;
    tray = this._sc_tray = XT.InternalTileCarouselTray.create();
    this.get('subsurfaces').pushObject(tray);
  }

});

XT.InternalTileCarouselTray = SC.CompositeSurface.extend({

  _sc_backgroundColor: base01,

  mouseDown: function(evt) {
    // console.log('XT.InternalTileCarouselTray#mouseDown()');
  ...
  mouseDragged: function(evt) {
    // console.log('XT.InternalTileCarouselTray#mouseDragged()');
  ...
  mouseUp: function(evt) {
    // console.log('XT.InternalTileCarouselTray#mouseUp()');
  ...
  updateLayout: function() {
    // console.log('XT.InternalTileCarouselTray#updateLayout()');
