...
XT.Request = SC.Request.extend({
  ...
  /**
    ...
    TODO: Use a one-way binding or other for more efficient retrieval.
  */
  session: function() {
  ...
  /**
    Ensures that the request body contains the session information so that
    the node datasource knows what client it is communicating with and that
  ...
  */
  ...
  /**
    First opportunity to respond to errors sent back by the node datasource
    (either from the datasource or from the database).

    TODO: Implement real error handling, this is merely helping know what
    happens when running Vows tests.
