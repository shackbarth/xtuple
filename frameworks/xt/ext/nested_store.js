...
// NOTE: This is a rather annoying hack.  The source code below is an 
// exact copy of SC.NestedStore from Blossom, so we can pick up the methods
// defined in XT.Store and still get correct nested store behavior. *sigh*
