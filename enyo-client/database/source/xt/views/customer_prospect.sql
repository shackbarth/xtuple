DO $$
  var dropSql = "drop view if exists xt.customer_prospect cascade;";
  var sql = "create or replace view xt.customer_prospect as " + 
  ...
  "from custinfo " + 
    ...
    "left join shiptoinfo on cust_id = shipto_cust_id and shipto_default " + 
  "union " + 
