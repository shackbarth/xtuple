...
NULL::text AS usr_passwd, COALESCE(( SELECT usrpref.usrpref_value::integer AS usrpref_value
FROM usrpref
...
FROM locale
ORDER BY locale.locale_id LIMIT 1))) AS usr_locale_id, COALESCE(( SELECT usrpref.usrpref_value
FROM usrpref
