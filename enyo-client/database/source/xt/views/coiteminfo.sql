...
update coitem set
  ...
  coitem_qtyshipped = new.coitem_qtyshipped,
  ...
  coitem_lastupdated = new.coitem_lastupdated,
  ...
  coitem_qtyreserved = new.coitem_qtyreserved,
