DO $$
  var dropSql = "drop view if exists xt.crmacctcomment cascade;";
  var sql = "create view xt.crmacctcomment as " +
    /* Account comments */
    "select comment_id, comment_source_id, comment_date, comment_user, comment_text, comment_cmnttype_id, comment_source, comment_public, obj_uuid " +
    "from comment " +
    "  left join cmnttype on (comment_cmnttype_id=cmnttype_id) " +
    "where (comment_source='CRMA') " +
    "union " +
    /* Customer comments */
    "select comment_id, crmacct_id, comment_date, comment_user, comment_text, comment_cmnttype_id, comment_source, comment_public, obj_uuid " +
    "from comment " +
