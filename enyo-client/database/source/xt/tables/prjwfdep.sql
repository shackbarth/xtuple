...
select xt.add_constraint('prjwfdep', 'prjwfdep_wfdep_source_id_fkey', 'foreign key (wfdep_source_id) references xt.prjwf (todoitem_id) on delete cascade');
select xt.add_constraint('prjwfdep', 'prjwfdep_wfdep_target_id_fkey', 'foreign key (wfdep_target_id) references xt.prjwf (todoitem_id) on delete cascade');
