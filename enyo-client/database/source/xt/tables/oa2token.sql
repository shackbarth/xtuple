...
select xt.add_column('oa2token','oa2token_usr_id', 'integer', '', 'xt', 'Indicates the usr_id this token exchange is for.');
...
select xt.add_column('oa2token','oa2token_delegate', 'integer', '', 'xt', 'usr_id for which a service_account is requesting delegated access as.');
