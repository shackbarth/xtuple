  ...
  XT.extensions.inventory.initParameters = function () {
    ...
    enyo.kind({
      ...
      components: [
        ...
        {name: "classCode", label: "_equals".loc(), attr: "itemSite.item.classCode",
        ...
        {name: "itemGroup", label: "_equals".loc(), attr: "itemSite.item.itemGroups.itemGroup.name",
          defaultKind: "XV.ItemGroupPicker"},
        {name: "itemGroupPattern", label: "_itemGroup".loc() + " " + "_pattern".loc(), attr: "itemSite.item.itemGroups.itemGroup.name"},
