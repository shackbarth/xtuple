...
//------Ignoring the indenting for better readability ---------
...
(function () {
  ...
  browser.waitForElementByXPath(contactObj.readObj1.readContact_xpath, 60000, function () {
  ...
  browser.waitForElementByXPath(contactObj.readObj1.heading_xpath, 10000, function (err) {
  ...
  browser.getValue(el11, function (err, value) {
  if (value === contactData.VARIABLES.contact_phone) utils.results('PASS: Phone No. verified');
