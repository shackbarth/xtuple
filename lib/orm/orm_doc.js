...
*/
{
  ...
  */
  "privileges": {
    ...
    */
    ...
    that contains one or both of its own key/value pairs whose keys would either be `view` or `edit`.
  ...
  */
  ...
  /**
  An array of triggers to be applied to the ORM generated view on insert, update and delete.
  This is the best place to capture complex business logic that is not already handled by
  underlying tables such as default values, validation and other calculated values.

  @type {Array}
  */
  "triggers": [
    "xt.owner_record_did_change"
  ],
