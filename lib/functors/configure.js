...
(function () {
  ...
  X.Functor.create({
    ...
    jsonToCsv: function (results) {
      ...
      // TODO: the headers have to be saved as a variable and
      // data really needs to iterate in order of the those headers
      // to make sure the columns line up. And we can't assume that
      // the first row has all the keys.
