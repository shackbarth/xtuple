...
(function () {
  ...
  */
  ...
  /**
    ...
    @extends XM.Model
  */
  XM.PentahoTempQueryData = XM.Model.extend(/** @lends XM.PentahoTempQueryData.prototype */{

    recordType: 'XM.PentahoTempQueryData',
  ...
  */
  ...
  /**
    ...
    @extends XM.Collection
  */
  XM.PentahoTempQueryDataCollection = XM.Collection.extend({
    /** @scope XM.PentahoTempQueryDataCollection.prototype */

    model: XM.PentahoTempQueryData
