...
(function () {
  ...
  X.Session = X.Object.extend(/** @lends X.Session.prototype */{
    ...
    query: function (query, callback) {
      ...
      if (this.payload.databaseType === 'global') {
        ...
        if (this.payload.requestType === 'fetch') {
          XT.dataSource.fetch(options);
        } else if (this.payload.requestType === 'dispatch') {
          XT.dataSource.dispatch(this.payload.className, this.payload.functionName, this.payload.parameters, options);
        }
      } else {
