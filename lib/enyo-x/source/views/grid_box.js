  ...
  /** @lends XV.GridBox# */{
    ...
    */
    ...
    valueChanged: function () {
      ...
      // The property domCssText is completely wrong on this object if it is the second grid box added
      // and the has to be scrolled to for editing
      // Can above hacks be removed because of this one?
      // This also takes care of re-rendering
