  ...
  enyo.kind(/** @lends XV.ReadOnlyRow# */{
    ...
    create: function () {
      ...
      _.each(columns, function (column) {
        ...
        _.each(column.attributes, function (attr) {
          components.push({
  ...
  /** @lends XV.GridBox# */{
    ...
    create: function () {
      ...
      var title = this.getTitle(),
        ...
        readOnlyRow = this.getReadOnlyRow(),
        editableRow = this.getEditableRow(),
      ...
      this.createComponent(
        {kind: "XV.Scroller", name: "mainGroup", horizontal: "hidden", fit: true, components: [
          {kind: "List", name: "aboveGridList", classes: "xv-above-grid-list",
            ...
            { kind: readOnlyRow, name: "aboveGridRow"}
          ]},
          {kind: editableRow, name: "editableGridRow", showing: false},
          {kind: "List", name: "belowGridList", classes: "xv-below-grid-list",
              onSetupItem: "setupRowBelow", ontap: "gridRowTapBelow", components: [
            {kind: readOnlyRow, name: "belowGridRow"}
          ]}
        ]}
      );
