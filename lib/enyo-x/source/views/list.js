...
(function () {
  ...
  enyo.kind(/** @lends XV.List# */{
    ...
    */
    ...
    /**
      Returns a list of available attributes that can be added as columns
      to the list.
    */
    ...
    */
    getSortableAttributes: function () {
      ...
      _.each(relationModels, function (relModel) {
        ...
        attributes = attributes.concat(XT.getObjectByName(relModel).getAttributeNames());
      });
