...
(function () {
  ...
  var list = /** @lends XV.List# */{
    ...
    /**
      Define any header array structure here.
    */
    ...
    */
    doneHelper: function (inEvent) {
      var model = this.getModel(inEvent.index),
        ...
        afterDone = function () {
          that.refreshModel(model, inEvent.done);
        };
    ...
    getExportActions: function () {
      ...
      if (!printAction) {
        actions.push({name: "printList"});
        actions.push({name: "printSelect"});
        actions.push({name: "reportList"});
      }
    ...
    */
    ...
    modelChanged: function (inSender, inEvent) {
      ...
      if (workspace && inEvent && workspace.prototype.model === inEvent.model &&
        ...
        this.refreshModel(model, inEvent.done);
      }
    },
    reportList: function () {
      this.doReportList();
    ...
    */
    ...
    refreshModel: function (model, afterDone) {
      var that = this,
        value = this.getValue(),
        Klass = XT.getObjectByName(this.getCollection()),
      ...
      checkStatusParameter = { attribute: this.getValue().model.prototype.idAttribute, operator: "=", value: model.id};
    ...
    */
    ...
    transformListAction: function (inSender, inEvent) {
      var index = inEvent.index,
        model = this.getFiltered().models[index];
