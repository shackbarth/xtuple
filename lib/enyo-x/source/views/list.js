...
(function () {
  ...
  enyo.kind(/** @lends XV.List# */{
    ...
    */
     ...
     */
    create: function () {
      var deleteAction = _.findWhere(this.getActions(), { "name": "delete" });
      this.inherited(arguments);
    ...
    */
	...
	next,
     ...
     /** 
	@todo cleanup the placement of the border of the list so that header is integrated properly
	*/
