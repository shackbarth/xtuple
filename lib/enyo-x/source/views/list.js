...
(function () {
  ...
  enyo.kind(/** @lends XV.List# */{
     ...
     * @property {Array} gearActions. Array of strings. What actions
    ...
    */
    ...
    setupItem: function (inSender, inEvent) {
      ...
      if (toggleSelected) {
        ...
        if (!gearIconButton || !isSelected) {
        ...
        } else if (this.gearActions.length > 0) {
          gearIconButton.applyStyle("display", "inline-block");
          ...
          gearIconButton.applyStyle("display", that._used[index] === false ? "inline-block" : "none");
    ...
    transformListItemMenuEvent: function (inSender, inEvent) {
      inEvent.gearActions = this.gearActions;
    }
  });
