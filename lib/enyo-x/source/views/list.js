  ...
  var list = /** @lends XV.List# */{
    ...
    */
    ...
    getExportActions: function () {
      var actions = this.exportActions || [],
        ...
        printAction = XT.session.config.printAvailable && this.getAllowPrint() && canExport ?
    ...
    */
    lazyLoad: function (scroll) {
      ...
      // If we didn't scroll, then assume we're at least at top
      max = scroll ? max : Math.max(max, 0);
