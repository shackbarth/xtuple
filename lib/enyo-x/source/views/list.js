    ...
    */
    ...
    setupItem: function (inSender, inEvent) {
      ...
      if (toggleSelected) {
        ...
        if (!actionIconButton || !isSelected) {
          actionIconButton.applyStyle("display", "none");

        } else if (actionIconButton && isSelected && hasDeletePrivileges) {
