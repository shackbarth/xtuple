  ...
  enyo.kind(/** @lends XV.List# */{
    ...
    */
    getDisplayAttributes: function () {
      ...
      // filter out characteristics because we don't have them to be in the
      // relation.name format
      relations = _.filter(model.prototype.relations, function (relation) {
        return relation.key !== "characteristics";
      });
      ...
      for (prop in this.$) {
        if (this.$.hasOwnProperty(prop)) {
          ...
          if (obj.getAttr) {
            ...
            if (!value && attr && (view.placeholder || view.showPlaceholder)) {
            ...
            // TODO: this belongs on the model in the formatting
