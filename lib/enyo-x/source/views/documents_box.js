  ...
  enyo.kind(
    ...
    */
    ...
    resolveModel: function (model, callback) {
      var documentAssociationMappings = {
        CRMA: XM.AccountRelation
      };
      var resolvedModel = new documentAssociationMappings[model.get("targetType")]();
      resolvedModel.fetch({
        id: model.get("target"),
    ...
    formatNumber: function (value, view, model) {
      if (this.resolvedModels[model.id]) {
        return this.resolvedModels[model.id].id;
      }
      return value;
    },
    /**
    ...
    formatType: function (value, view, model) {
      var documentAssociationTypes = {
        CRMA: "_account".loc()
      };
      return documentAssociationTypes[value] || value;
    },
    /**
