  ...
  enyo.kind(
    ...
    components: [
      ...
      {kind: "FittableRows", classes: "enyo-fit", components: [
        ...
        {name: "containerPanels", kind: "enyo.Panels", fit: true, arrangerKind: "cardArranger", components: [
      ...
      if (name === 'history') {
        ...
        if (inEvent.show && !forceMin && !inEvent.minimizing) {
          ...
          for (var i = 0; i < this.$.containerPanels.getPanels().length; i++) {
            if (this.$.containerPanels.getPanels()[i].name === name) {
              panelExists = true;
              continue;
            }
          }
          if (panelExists) {
            ...
            var panel = this.$.containerPanels.createComponent(item);
            panel.render();
