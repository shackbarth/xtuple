...
(function () {
  ...
  enyo.kind(
    ...
    components: [
      ...
      //{kind: "Scroller", name: "pulloutItems", fit: true, horizontal: "hidden",
        //classes: "pullout-scroller", components: [
      {name: "containerPanels", kind: "enyo.Panels", style: "height: 100%", components: [
        {name: "history", components: [
          {classes: "xv-pullout-header", content: "_history".loc()},
        ...
        {name: "help", components: [
          {classes: "xv-pullout-header", content: "_help".loc()}, // XXX will this get wiped out?
        ]}
      ]}
    ],
    /**
    ...
    */
    grabberDragFinish: function (inSender, inEvent) {
      var name = this.getSelectedPanel() ? this.getSelectedPanel() : "history",
        minimizing = inEvent.dragInfo && inEvent.dragInfo.minimizing;

      this.togglePullout(this, {name: name, show: true, minimizing: minimizing});
    },
    /**
    ...
    */
    togglePullout: function (inSender, inEvent) {
      ...
      var name = inEvent.name,
        ...
        forceMin = this.isAtMax() && !isGripperOriginated;
        // TODO: don't force min if the user is swapping between adv search and history
      ...
      if (name === 'history') {
        ...
        this.$.help.destroyClientControls();
        ...
        // we get inEvent.minimizing from the gripper event
        if (inEvent.show && !forceMin && !inEvent.minimizing) {
          ...
          if (panelExists) {
            ...
            var panel = this.$.containerPanels.createComponent(
              {kind: "Scroller", name: item.name + "Scroller", components: [
                {classes: "xv-pullout-header", content: "_advancedSearch".loc()},
                item
              ]}
            );
            panel.render();
