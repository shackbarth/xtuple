  ...
  */
  enyo.kind(
    ...
    create: function () {
      ...
      // Buttons
      buttons = {kind: 'FittableColumns', name: "buttonsPanel", classes: "xv-groupbox-buttons",
        components: [
      ]};
      ...
      if (canAttach) {
        ...
        {kind: "onyx.Button", name: "attachButton", onclick: "attachItem",
          content: "_attach".loc(),
          classes: canOpen ? "xv-groupbox-button-center" :
            "xv-groupbox-button-left",
          disabled: true},
        {kind: "onyx.Button", name: "detachButton", onclick: "detachItem",
          content: "_detach".loc(),
          classes: canOpen ? "xv-groupbox-button-center" :
            "xv-groupbox-button-right",
          disabled: true});
      }
      if (canOpen) {
        buttons.components.push(
    ...
    selectionChanged: function (inSender, inEvent) {
      ...
      //  couldNotRead = model ? !model.couldRead() : true,
        couldNotRead = model.couldRead ? !model.couldRead() : !model.getClass().canRead(),
        couldNotUpdate = model.couldUpdate ? !model.couldUpdate() : !model.getClass().canUpdate();
    ...
    updateButtons: function () {
      var value = this.getValue(), // Must be a collection of Info models
        ...
        editableModel = value && value.model.prototype.editableModel ?
          value.model.prototype.editableModel : value.model.prototype.recordType,
        Klass = editableModel ?
