  ...
  enyo.kind(
    ...
    selectionChanged: function (inSender, inEvent) {
      var index = this.$.list.getFirstSelected(),
        ...
        couldNotRead = model ? (model.couldRead ? !model.couldRead() : !model.getClass().canRead()) : true,
        couldNotUpdate = model ? (model.couldUpdate ? !model.couldUpdate() : !model.getClass().canUpdate()) : true;
