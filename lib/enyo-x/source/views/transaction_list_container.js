  ...
  var transactionListContainer =  /** @lends XV.TransactionListContainer# */ {
    ...
    components: [
      {name: "parameterPanel", kind: "FittableRows", classes: "left",
        ...
        {name: "transactionListHeader", content: "_search".loc(), tag: "textarea", disabled:true, style:"height: 80px;width: 300px;"},
    ...
    */
    ...
    appendHeader: function (inSender, inEvent) {
      this.$.transactionListHeader.setContent(this.$.transactionListHeader.getContent() + inEvent.data);
    },
    updateHeader: function (inSender, inEvent) {
      if (inEvent.noItemFound) {
        this.appendHeader(inSender, inEvent);
        //this.$.transactionListHeader.setContent(inEvent.data);
