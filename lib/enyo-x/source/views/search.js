...
(function () {
  ...
  /** @lends XV.SearchContainer# */{
      ...
      {name: "parameterPanel", kind: "FittableRows", classes: "left",
        ...
        {kind: "onyx.Toolbar", classes: "onyx-menu-toolbar", components: [
          {kind: "onyx.Button", name: "backButton", content: "_back".loc(),
            ontap: "close"},
          {kind: "onyx.MenuDecorator", style: "margin: 0;", onSelect: "listActionSelected", components: [
    ...
    actionSelected: function (inSender, inEvent) {
      var actionDefinition = inEvent.originator.action,
      modelName = actionDefinition.modelName,
      Klass = XT.getObjectByName(modelName),
      model = new Klass(),
      methodName = actionDefinition.method;
      model[methodName]();
    },
    */
