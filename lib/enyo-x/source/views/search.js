  ...
  enyo.kind(
    ...
    components: [
      ...
      {name: "listPanel", kind: "FittableRows", components: [
        ...
        {kind: "onyx.MoreToolbar", name: "contentToolbar",
          ...
          // TODO: need to get rid of these floats!
        ...
        {name: "contentPanels", kind: "Panels",
          margin: 0, fit: true, draggable: false, panelCount: 0}
      ]}
    ],
    init: false,
    ...
    */
    ...
    /**
      ...
      @see {XM.ParameterWidget} For parameterItemValues convention
    */
