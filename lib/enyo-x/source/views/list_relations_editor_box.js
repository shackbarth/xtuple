  ...
  enyo.kind(/** @lends XV.ListRelationsEditorBox# */{
    ...
    */
    ...
    disabledChanged: function () {
      if (this.getDisabled()) {
        // Plan A: has the advantage of disabling buttons that are added by subkinds
        // (e.g. the expand button) but has the disadvatage that it relies on the
        // buttons being onyx buttons
        ...
        // TODO: do we ever need to selectively re-enable?
      }
    },
    /**
