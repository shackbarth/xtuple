    ...
    */
    buildActionMenu: function () {
      var menu = this.$.actionMenu,
        index = this.$.menuPanels.getIndex(),
        activePanel = this.$.contentPanels.getActive(),
        actions = index ? this.getSelectedModule().actions || [] : this.getActions(),
        privileges = XT.session.privileges;

      if (index && activePanel.getNavigatorActions) {
