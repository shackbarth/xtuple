  ...
  var navigator = /** @lends XV.Navigator# */{
    ...
    */
    ...
    fetch: function (options) {
      ...
      if (!(list instanceof XV.List) && !(list instanceof XV.Dashboard) && !(typeof XV.BiDashboard !== "undefined" || list instanceof XV.BiDashboard)) { return; }
    ...
    */
    ...
    newRecord: function (inSender, inEvent) {
      ...
      if (typeof XV.BiDashboard !== "undefined") {
        if (list instanceof XV.BiDashboard && item) {
          list.newRecord(item);
          return true;
        }
      }
