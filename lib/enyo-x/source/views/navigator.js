  ...
  var navigator = /** @lends XV.Navigator# */{
    ...
    components: [
      ...
      {kind: "FittableRows", components: [
        ...
        {kind: "onyx.MoreToolbar", name: "contentToolbar",
          ...
          {name: "saveButton", kind: "font.IconButton",
            icon: "save", content: "_save".loc(),
            ontap: "save" },
    ...
    */
    buildMenus: function () {
      ...
      // DISPLAY SAVE BUTTON FOR EDITABLE LISTS
      this.$.saveButton.setShowing(activePanel.gridRowTapAbove);
    ...
    */
    ...
    save: function (options) {
      ...
      // XXX list item models will have to be editable
      _.each(list.getValue().models, function (model) {
        if (model.isDirty()) {
          model.save();
        }
      });
