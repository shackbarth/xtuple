  ...
  enyo.kind(/** @lends XV.Navigator# */{
    ...
    */
    published: {
      ...
      panelCache: {},
      actions: [
        //{name: "printItem", label: "_print".loc(), showing: false},
        //{name: "exportItem", label: "_export".loc(), showing: false},
        {name: "myAccountItem", label: "_changePassword".loc()},
        {name: "helpItem", label: "_help".loc()},
        {name: "aboutItem", label: "_about".loc()},
        {name: "newTabItem", label: "_openNewTab".loc()}
      ],
    },
    events: {
      onListAdded: "",
    ...
    buildActionMenu: function () {
      ...
      _.each(actions, function (action) {
        var name = action.name,
          ...
          isDisabled = privilege ? XT.Session.settings.privileges.get(privilege) : false;
