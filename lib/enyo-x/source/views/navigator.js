    ...
    */
    published: {
      ...
      actions: [
        ...
        {name: "helpItem", label: "_help".loc(), method: "showHelp"},
        {name: "aboutItem", label: "_about".loc(), method: "showAbout"},
        {name: "newTabItem", label: "_openNewTab".loc(), method: "newTab"}
      ],
    },
    events: {
      onListAdded: "",
      ...
      {kind: "FittableRows", components: [
        ...
        {kind: "onyx.MoreToolbar", name: "contentToolbar",
          ...
          {kind: "onyx.MenuDecorator", style: "margin: 0;", onSelect: "newRecord", components: [
            // To use menu look instead of icon
            // {content: "_new".loc(), kind: "onyx.Button", components: [
            //   {content: "_new".loc()},
            //   {tag: "span", classes: "icon-caret-down picker-icon"}
            // ]},
    ...
    */
    buildMenus: function () {
      var actionMenu = this.$.actionMenu,
        ...
        ary = idx ? this.getSelectedModule().actions || [] : this.getActions(),
        actions = ary.slice(0),
      ...
      // don't even worry about the new menu if there are no actions
      if (!activePanel.newActions) {
        return true;
      }
    ...
    */
    ...
    fetch: function (options) {
      ...
      if (input || parameters.length ||
         (query.parameters && query.parameters.length)) {
        // if the query already has parameters set in the widget
        // keep those, and concatenate any search params
