  ...
  enyo.kind(/** @lends XV.Navigator# */{
    ...
    */
    ...
    components: [
      ...
      {kind: "FittableRows", components: [
        ...
        {name: "deletePopup", kind: "onyx.Menu", floating: true, onSelect: "itemSelected", components: [
          {content: "hi"},
          {content: "there"}
        ]},
    ...
    */
    ...
    showDeletePopup: function (inSender, inEvent) {
      var node = inEvent.originator.eventNode || inEvent.originator.hasNode();
      this.$.deletePopup.activatorOffset = this.$.deletePopup.activatorOffset || node.getBoundingClientRect();
      ...
      this.$.deletePopup.adjustPosition();
      //this.waterfall("onRequestMenuShowSpecial", inEvent);
    },
