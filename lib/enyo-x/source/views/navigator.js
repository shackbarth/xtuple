...
(function () {
  ...
  var navigator = /** @lends XV.Navigator# */{
    ...
    */
    ...
    showPullout: true,
    components: [
      {kind: "FittableRows", name: "nav-menu", classes: "left", components: [
    ...
    */
    ...
    printSelectList: function (inSender, inEvent) {
      console.log("In printSelectList");
      var list = this.$.contentPanels.getActive(),
    ...
    */
    openExportTab: function (routeName) {
      ...
      console.log("route: " + XT.getOrganizationPath() +
    ...
    itemTap: function (inSender, inEvent) {
      console.log("nagigator item tap");
