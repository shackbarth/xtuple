    ...
    */
    ...
    components: [
      ...
      {kind: "FittableRows", components: [
        ...
        {name: "listItemMenu", kind: "onyx.Menu", floating: true, onSelect: "listActionSelected", components: [
          {name: "delete", content: "_delete".loc()}
        ]},
    ...
    */
    ...
    showListItemMenu: function (inSender, inEvent) {
      ...
      _.each(this.$.listItemMenu.$, function (value, key) {
        // TODO: sometimes 'delete' should be hidden as well
        if (value.kind === 'onyx.MenuItem' && key !== 'delete') {
          value.hide();
        }
      });
