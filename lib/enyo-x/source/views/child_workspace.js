    ...
    components: [
      ...
      {kind: "FittableRows", name: "contentPanel", components: [
        {kind: "onyx.MoreToolbar", name: "contentToolbar", components: [
          ...
          {kind: "onyx.Button", name: "previousButton",
            content: "_previous".loc(), onclick: "previousItem"},
        ...
        // TODO: delete a lot of these components
    ...
    */
    setWorkspace: function (options) {
      ...
      if (workspace) {
        ...
        this.render();
        workspace.setValue(currentModel);
        workspace.attributesChanged(currentModel);
      }
