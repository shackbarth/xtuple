  ...
  */
  enyo.kind({
    ...
    components: [
      {kind: "onyx.Toolbar", components: [
        {kind: "onyx.MenuDecorator", onSelect: "itemSelected",
          components: [
            {content: "_addChart".loc(), kind: "onyx.Button",
                onActivate: "", classes: "split-menu"},
            {content: "v", allowHtml: true, classes: "split-menu"},
            {kind: "onyx.Menu", name: "menu"}
        ]},
        {kind: "onyx.Button", content: "_removeChart".loc(), ontap: "removeChart"}
      ]},
    ...
    addChart: function (value) {
      var p = this.$.panels,
        component = {kind: value, classes: "dashboard-chart"},
