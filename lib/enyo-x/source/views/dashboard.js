...
(function () {
  ...
  */
  enyo.kind({
    ...
    components: [
      {kind: "onyx.Toolbar", components: [
        {kind: "onyx.MenuDecorator", onSelect: "itemSelected",
          components: [
            {content: "Add Chart", kind: "onyx.Button",
                onActivate: "preventActivate", classes: "split-menu"},
            {content: "v", allowHtml: true, classes: "split-menu"},
            {kind: "onyx.Menu", components: [
              {content: "XV.SalesHistoryTimeSeriesChart"}
            ]}
        ]}
      ]},
      {name: "arranger", kind: "ChartsArranger"}
    ],
    /* Add a chart to the arranger */
    addChart: function (value) {
      var panels = this.$.arranger,
        component = {kind: value, classes: "chart"},
    ...
    /* Remove the current active chart */
    ...
    /* Prevents the button in the split window from showing the window */
    preventActivate: function () {
        return true;
    },
    ...
    itemSelected: function (inSender, inEvent) {
      if (inEvent.originator.content) {
          ...
          this.addChart(inEvent.originator.content);
      }
    }
  });
    ...
    components: [
      ...
      {kind: "enyo.FittableColumns", components: [
        {content: "_filterOn".loc() + ": ", classes: "xv-picker-label",
          style: "color: white", name: "filterPickerLabel" },
