  ...
  */
  ...
  enyo.kind({
    ...
    processData: function () {
      ...
      aggregatedData = _.map(groupedData, function (group, key) {
        var x = -1,
          // TODO: need to make a histogram by doing another _.groupBy / _.reduce
          groupValues = _.map(group, function (modelData) {
            x++;
            return {
              x: x,
