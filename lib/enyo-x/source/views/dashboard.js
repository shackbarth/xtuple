  ...
  enyo.kind({
    ...
    */
    addModel: function (kind) {
      var that = this, options = {},
        ...
        value = new Klass(null, {isNew: true});

        value.set("chartname", kind);
        value.set("extension", that.getExtension());
        value.set("username", XT.session.details.username);

        that.getValue().add(value);
        that.addChart(value);

      // options.success = function (model, resp, options) {
      //   that.getValue().add(model);
      //   that.addChart(model);
      // };
      // value.fetch(options);
    },
    ...
    */
    ...
    saveDashboard: function (inSender, inEvent) {
      var options = {};
      options.success = function (model, resp, options) {
        // TODO: Do something after the save is successful
  ...
  enyo.kind(
    ...
    */
    ...
    filterAttrChanged: function () {
      //this.$.filterPicker.setSelected(this.getFilterAttr());
      this.processData();
    },
    ...
    groupByAttrChanged: function () {
      //this.$.groupByPicker.setSelected(this.getGroupByAttr());
      this.processData();
    },
    ...
    */
    modelChanged: function () {
      ...
      this.setFilterAttr(model.get("filter"));
