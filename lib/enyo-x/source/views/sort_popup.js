  ...
  enyo.kind({
    ...
    populateFromCookie: function () {
      var dbName = XT.session.details.organization,
        cookieName = 'sortPickerCache_' + dbName + '_' + this.list.name + '_' + this.name,
    ...
    // our itemSelected function on this.$.sortPicker1 doesn't work either
      ...
      pickers.attr2 = attr2;
      pickers.attr3 = attr3;
      pickers.attr1type = attr1type;
      pickers.attr2type = attr2type;
      pickers.attr3type = attr3type;
      dbName = XT.session.details.organization;
      cookieName = 'advancedSearchCache_' + dbName + '_' + this.list.name + '_' + this.name;
