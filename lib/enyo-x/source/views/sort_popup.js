  ...
  enyo.kind({
    ...
    setPickerSelections: function (params) {
      var picker1 = this.$.sortPicker1.$.picker,
        ...
        param1 = params.attr1 ? params.attr1 : picker1.getComponents()[2],
        param2 = params.attr2 ? params.attr2 : picker2.getComponents()[1],
        param3 = params.attr3 ? params.attr3 : picker3.getComponents()[1],
        param4 = params.type1 ? params.type1 : type1.getComponents()[1],
        param5 = params.type2 ? params.type2 : type2.getComponents()[1],
        param6 = params.type3 ? params.type3 : type3.getComponents()[1];


      picker1.setSelected(param1);
      picker2.setSelected(param2);
      picker3.setSelected(param3);
      type1.setSelected(param4);
      type2.setSelected(param5);
      type3.setSelected(param6);
    },
    ...
    // our itemSelected function on this.$.sortPicker1 doesn't work either
      ...
      var options,
        ...
        payload;
      params.listName = this.list.name;
      params.attr1 = this.$.sortPicker1.$.picker.getSelected();
      params.attr2 = this.$.sortPicker2.$.picker.getSelected();
      params.attr3 = this.$.sortPicker3.$.picker.getSelected();
      params.type1 = this.$.sortTypePicker1.$.picker.getSelected();
      params.type2 = this.$.sortTypePicker2.$.picker.getSelected();
      params.type3 = this.$.sortTypePicker3.$.picker.getSelected();
