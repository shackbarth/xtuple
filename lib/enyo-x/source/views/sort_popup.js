  ...
  enyo.kind({
    ...
    setPickerSelections: function (params) {
      var picker1 = this.$.sortPicker1.$.picker,
        ...
        param1 = params.attr1 ? params.attr1 : 2,
        param2 = params.attr2 ? params.attr2 : 1,
        param3 = params.attr3 ? params.attr3 : 1,
        param4 = params.type1 ? params.type1 : 1,
        param5 = params.type2 ? params.type2 : 1,
        param6 = params.type3 ? params.type3 : 1;


      picker1.setSelected(picker1.getComponents()[param1]);
      picker2.setSelected(picker2.getComponents()[param2]);
      picker3.setSelected(picker3.getComponents()[param3]);
      type1.setSelected(type1.getComponents()[param4]);
      type2.setSelected(type2.getComponents()[param5]);
      type3.setSelected(type3.getComponents()[param6]);
    },
    ...
    // our itemSelected function on this.$.sortPicker1 doesn't work either
      ...
      var options,
        ...
        payload;
      params.listName = this.list.name;
      params.attr1 = this.$.sortPicker1.index;
      params.attr2 = this.$.sortPicker2.index;
      params.attr3 = this.$.sortPicker3.index;
      params.type1 = this.$.sortTypePicker1.index;
      params.type2 = this.$.sortTypePicker2.index;
      params.type3 = this.$.sortTypePicker3.index;
