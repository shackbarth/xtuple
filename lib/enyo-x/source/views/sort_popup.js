...
(function () {
  ...
  enyo.kind({
    ...
    setPickerStrings: function (inSender, inEvent) {
      ...
      var unwanted = ["id", "characteristics", "address",
        "uuid", "priorityOrder", "statusOrder", "password"];
      ...
      this.$.sortTypePicker1.$.picker.setSelected(this.$.sortTypePicker1.$.picker.controls[1]);
      this.$.sortTypePicker2.$.picker.setSelected(this.$.sortTypePicker1.$.picker.controls[1]);
      this.$.sortTypePicker3.$.picker.setSelected(this.$.sortTypePicker1.$.picker.controls[1]);
    },
