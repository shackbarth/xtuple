  ...
  */
  ...
  enyo.kind(/** @lends XV.WorkspaceContainer# */{
    ...
    actionSelected: function (inSender, inEvent) {
      ...
      if (inEvent.selected.isViewMethod) {
        this.$.workspace[inEvent.selected.method](inEvent);

      // Otherwise call it on the workspace's model.
      } else {
        this.$.workspace.getValue()[inEvent.selected.method]();
      }
    },
    ...
    buildMenus: function () {
      var actionMenu = this.$.actionMenu,
        actions = this.$.workspace.getActions(),
