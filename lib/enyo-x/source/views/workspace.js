  ...
  */
  ...
  var workspaceHash = enyo.mixin(XV.EditorMixin, /** @lends XV.Workspace# */{
    ...
    create: function () {
      ...
      this.titleChanged();
      this.setIsBiAvailable(XT.reporting);
    },
    /**
  ...
  enyo.kind(/** @lends XV.WorkspaceContainer# */{
    ...
    save: function (options) {
      ...
      if (this.$.workspace.printOnSaveSetting && this.getIsBiAvailable() &&
    ...
    */
    setWorkspace: function (options) {
      ...
      if (workspace) {
        ...
        //
        this.$.printButton.setShowing(workspace.allowPrint && this.getIsBiAvailable());
