    ...
    components: [
      ...
      {kind: "FittableRows", name: "contentPanel", components: [
        ...
        {kind: "onyx.Popup", name: "errorPopup", centered: true,
          ...
          {tag: "br"},
          {kind: "onyx.Button", content: "_ok".loc(), name: "errorOk", ontap: "errorOk", classes: "onyx-blue xv-popup-button"},
          {kind: "onyx.Button", content: "_yes".loc(), name: "errorYes", ontap: "errorOk", classes: "onyx-blue xv-popup-button"},
          {kind: "onyx.Button", content: "_no".loc(), name: "errorNo", ontap: "errorOk", classes: "onyx-blue xv-popup-button"}
        ]},
