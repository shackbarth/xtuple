  ...
  enyo.kind(/** @lends XV.CommentBoxItem# */{
    ...
    components: [
      ...
      {kind: "XV.CommentTypePicker", name: "commentType", attr: "commentType",
        showing: false},
      {kind: "XV.TextArea", name: 'textArea', attr: "text", showing: false, showBorder: true}
    ],
    /**
    ...
    */
    ...
    /**
    @todo Document the openEditableArea method.
    */
    ...
    */
    ...
    /**
    @todo Document the hideEditableArea method.
    */
