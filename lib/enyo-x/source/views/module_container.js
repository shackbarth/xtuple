...
(function () {
  ...
  enyo.kind(
    ...
    /**
      Do the exact same thing as addPanel, just use a ChildWorkspaceContainer
      instead of a WorkspaceContainer.
     */
    addChildWorkspacePanel: function (inSender, inEvent) {
      this.addPanel(inSender, inEvent, "XV.ChildWorkspaceContainer");
    },
    /**
      Create and drill down into a new workspace as defined by the inEvent object
     */
    addPanel: function (inSender, inEvent, workspaceContainerKind) {
      var panel;
