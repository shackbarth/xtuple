  ...
  enyo.kind(
    ...
    */
    ...
    popupWorkspace: function (inSender, inEvent) {
      ...
      //inEvent.model.on("notify", this.popupWorkspaceNotify, this);
      //inEvent.model.on("invalid", this.popupWorkspaceNotify, this);
    ...
    popupWorkspaceTap: function (inSender, inEvent) {
      var response = inEvent.originator.name === 'popupWorkspaceCancel' ?
        false :
        this.$.popupWorkspace.$.workspace.value;

      this.$.popupWorkspace.hide();
      //this.$.popupWorkspace.$.workspace.value.off("notify", this.popupWorkspaceNotify, this);
      //this.$.popupWorkspace.$.workspace.value.off("invalid", this.popupWorkspaceNotify, this);
