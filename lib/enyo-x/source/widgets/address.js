...
/*global XT:true, XV:true, XM:true, Backbone:true, enyo:true, _:true, window:true */
...
(function () {
  ...
  enyo.kind(
    ...
    components: [
      ...
      {kind: "FittableColumns", classes: "xv-addresswidget-buttons",
        ...
        {kind: "onyx.Button", name: "searchButton", content: "_search".loc(),
          ...
          classes: "xv-addresswidget-button"},
        {kind: "onyx.Button", name: "mapButton", content: "_map".loc(),
          ontap: "mapButtonTap",
          classes: "xv-addresswidget-button"}
      ]},
    ...
    */
    mapButtonTap: function (inSender, inEvent) {
      ...
      address[0] = model.get('line1') || "";
      address[1] = model.get('line2') || "";
      address[2] = model.get('line3') || "";
      address[3] = model.get('city') || "";
      address[4] = model.get('state') || "";
      address[5] = model.get('postalCode') || "";
      address[6] = model.get('country') || "";
      ...
      var win = window.open("http://maps.google.com/?q=" + address.join(''));
      return true;
    },
    /**
    ...
    */
    setValue: function (value, options) {
      ...
      if (value instanceof XM.Model && value.recordType !== 'XM.AddressInfo') {
