  ...
  enyo.kind(/** @lends XV.Number# */{
    ...
    */
    setValue: function (value, options) {
      ...
      value = !isNaN(value) ? XT.math.round(value, this.getScale()) : null;
    ...
    valueChanged: function (value) {
      ...
      value = !isNaN(value) ? Globalize.format(value, "n" + this.getScale()) : "";
    ...
    components: [
      {kind: "FittableColumns", components: [
        ...
        {kind: "onyx.InputDecorator", classes: "xv-input-decorator",
          components: [
          {name: "input", kind: "onyx.Input", onchange: "inputChanged", onkeydown: "keyDown", type: "number", style: "text-align: right;"}
        ]}
      ]}
    ],
    /**
