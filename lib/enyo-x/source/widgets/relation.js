...
(function () {
  ...
  enyo.kind(/** @lends XV.RelationWidget# */{
    ...
    published: {
      ...
      bespokeFilter: null // whatever the subkind wants it to be
    },
    events: {
      onSearch: "",
      onValueChange: "",
    ...
    autocomplete: function (callback) {
      ...
      if (value && value !== attr) {
        this.fetchCollection(value, 1, "_fetchSuccess");
      } else if (!value) {
        this.setValue(null);
      }
    },
    ...
    disabledChanged: function () {
      ...
      this.$.iconButton.setDisabled(disabled);
    ...
    menuItemSelected: function (inSender, inEvent) {
      ...
      case 'searchItem':
        ...
        this.doSearch({
          ...
          bespokeFilter: this.getBespokeFilter()
        });
        break;
      case 'openItem':
        this.doWorkspace({
