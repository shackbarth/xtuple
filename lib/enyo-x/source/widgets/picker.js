    ...
    */
    ...
    keyUp: function (inSender, inEvent) {
      var keyCode = inEvent.keyCode,
        ...
        currentIndex = _.indexOf(controlsContents, currentSelection.content),
        newSelection,
        newIndex;
/*
      if (currentSelection === undefined &&
          this.$.picker.controls.length > 0 &&
          this.$.picker.controls[0].value === undefined) {
        // workaround if the current position is the blank space at the top of the picker
        currentIndex = 0;
      }
*/
      if (keyCode === 40) {
    ...
    components: [
      {kind: "FittableColumns", components: [
        ...
        {kind: "onyx.InputDecorator", name: "inputWrapper", classes: "xv-input-decorator",
          ...
          {kind: "onyx.PickerDecorator",
            components: [
            {kind: "XV.PickerButton", name: "pickerButton", content: "_none".loc()},
            {name: "picker", kind: "onyx.Picker"}
          ]}
        ]}
      ]}
