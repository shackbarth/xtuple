...
(function () {
  ...
  enyo.kind(/** @lends XV.PickerWidget# */{
    ...
    components: [
      {kind: "onyx.PickerDecorator",
        components: [
        {kind: "XV.PickerButton", content: "_none".loc()},
    ...
    buildList: function (options) {
      ...
      for (i = 0; i < models.length; i++) {
        ...
        component = { value: model, content: name };
      ...
      {kind: "FittableColumns", components: [
        ...
        {kind: "onyx.InputDecorator", name: "inputWrapper", classes: "xv-input-decorator",
          ...
          {kind: "onyx.PickerDecorator",
            components: [
            {kind: "XV.PickerButton", content: "_none".loc()},
            {name: "picker", kind: "XV.ScrollingPicker"}
          ]}
        ]}
      ]}
    ],
  ...
  */
  ...
  /**
    Implementation of onyx.Picker that includes a scroller.
  */
  enyo.kind({
    name: "XV.ScrollingPicker",
    kind: "onyx.Picker",
    components: [
      {name: "pickerScroller", kind: "enyo.Scroller", defaultKind: "onyx.MenuItem",
        vertical: "auto", classes: "enyo-unselectable",
        maxHeight: "200px", strategyKind: "TouchScrollStrategy"}
    ],
    /**
      Override of createComponent so that picker items are added
      to the scroller instead of the picker directly.
    */
    createComponent: function (component) {
      this.$.pickerScroller.createComponent(component);
    }
  });
