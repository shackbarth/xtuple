...
(function () {
  ...
  var _selectValue = function (widget, value) {
    var key = widget._collection.model.prototype.idAttribute,
      component;
    value = value ? value.get(key) : value;
    component = _.find(widget.$.picker.getComponents(), function (c) {
  ...
  enyo.kind(/** @lends XV.PickerWidget# */{
    ...
    */
    ...
    setValue: function (value, options) {
      options = options || {};
      var key = this._collection.model.prototype.idAttribute,
