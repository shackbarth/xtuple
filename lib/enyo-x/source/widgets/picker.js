...
(function () {
  ...
  enyo.kind(/** @lends XV.PickerWidget# */{
    ...
    published: {
      attr: null,
      value: null,
      listModels: null, // models to be converted to picker items
      collection: null,
      disabled: false,
      nameAttribute: "name",
      orderBy: null,
      noneText: "_none".loc(), // text to be shown if the picker has no value
      noneClasses: "", // css classes for empty value picker item
      showNone: true, // show empty value in picker item list
      prerender: true
    },
    handlers: {
