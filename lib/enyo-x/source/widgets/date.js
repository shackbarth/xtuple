...
(function () {
  ...
  enyo.kind(/** @lends XV.Date# */{
    ...
    textToDate: function (value) {
      ...
      // many formats.
        ...
        // retrun an invalid Date object and we will catch it later. If we need more stringent checking, we
      ...
      console.log("This is what text to date is returning:" + date);
      return date;
    },
    /**
  ...
  enyo.kind(/** @lends XV.DateWidget# */{
    ...
    */
    ...
    /**
     This function is a work-around for Issue 18397. It can be removed
     once Enyo fixes ENYO-1104.
     */
