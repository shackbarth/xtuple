  ...
  */
  enyo.kind(enyo.mixin(/** @lends XV.ParameterWidget# */{
    ...
    create: function () {
      ...
      // Add the save/manage filter form to the beginning
      // of the component array
      this.createComponent({kind: "XV.FilterForm", addBefore: null});

      this.processExtensions();

      // TODO: populate from last search or default
  ...
  enyo.kind({
    ...
    components: [
      {kind: "FittableColumns",
        style: "background-color: #fff; padding: 5px; text-align: center;", components: [
          {kind: "onyx.Button", content: "_saveFilter".loc(), ontap: "activateSave", style: "margin-right: 3px;"},
      ...
      {kind: "onyx.Drawer", name: "saveDrawer", open: false, animated: true, components: [
        ...
        {kind: "FittableColumns",
          style: "background-color: #fff; padding: 5px; text-align: center;", components: [
            {kind: "onyx.Button", content: "_apply".loc(), style: "margin-right: 3px;"},
    ...
    activateSave: function () {
      this.$.saveDrawer.setOpen(true);
    },
    activateManage: function () {
      this.$.manageDrawer.setOpen(true);
    }
  });
