  ...
  */
  enyo.kind({
    ...
    components: [
      ...
      {kind: "XV.PickerWidget", label: "_filter".loc()},
      {content: "_more".loc(), ontap: "activateForm", classes: "button-row more-row"},
      {kind: "onyx.Drawer", name: "formDrawer",
        open: false, animated: true, components: [
          {kind: "FittableColumns", classes: "button-row", components: [
              {kind: "onyx.Button", content: "_saveFilter".loc(), ontap: "activateSave"},
              {kind: "onyx.Button", content: "_manage".loc(), ontap: "activateManage"}
          ]},
          ...
          {kind: "onyx.Drawer", name: "manageDrawer", open: false, animated: true, components: [
            {kind: "onyx.GroupboxHeader", content: "_manageFilter".loc()},
    ...
    activateForm: function (inSender, inEvent) {
      var isOpen = this.$.formDrawer.open,
        content = "_more".loc();
      this.$.formDrawer.setOpen(!isOpen);
      if (!isOpen) {
        content = "_less".loc();
      }
      inEvent.originator.setContent(content);
    },
    activateSave: function () {
      this.$.saveDrawer.setOpen(!this.$.saveDrawer.open);
    },
    activateManage: function () {
