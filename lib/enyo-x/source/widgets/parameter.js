...
(function () {
  ...
  */
  enyo.kind(enyo.mixin(/** @lends XV.ParameterWidget# */{
    ...
    create: function () {
      ...
      // TODO: if this cookie has no values, we want to
    ...
    /**
     Remember the state of this parameter widget and
    ...
    */
    saveFilter: function (inSender, inEvent) {
      ...
      model.set("kind", this.kind);

      options.success = function (model, resp, options) {
        // dear filter form, we're all done!
        inEvent.callback();
      };
    ...
    */
    ...
    /**
     Reads and parses the values from the saved cookie
     object and populates the fields with the parameter
     values.
     */
    populateFromCookie: function () {
      ...
      this.populateParameters(cookieValue);
    },
    /**
  ...
  /**
    This is a component that includes the save/manage buttons
    for saving filters and two drawers that show and hide content
  ...
  */
  enyo.kind({
    ...
    components: [
      {kind: "onyx.GroupboxHeader", content: "_savedFilters".loc()},
      ...
      {kind: "onyx.Drawer", name: "saveDrawer", open: false, animated: true, components: [
        ...
        {kind: "FittableColumns", classes: "button-row", components: [
          {kind: "onyx.Button", name: "apply", disabled: true, content: "_apply".loc(), ontap: "saveFilter"},
      ...
      {kind: "onyx.Drawer", name: "manageDrawer", open: false, animated: true, components: [
        ...
        {kind: "XV.FilterList", name: "filterList"},
        {kind: "FittableColumns", classes: "button-row", components: [
          // TODO: Add share and delete buttons.
    ...
    */
    ...
    /**
      Opens the manage filter drawer, switches the drawer
      icons and loads the list of filters.
    */
    activateManage: function (inSender, inEvent) {
      ...
      this.$.filterList.fetch(options);
      // open the drawer and switch the icon
    ...
    */
    saveFilter: function (inSender, inEvent) {
      var name = this.$.filterName.getValue(),
        ...
        that = this,
      inEvent = {filterName: name, isShared: shared,
        callback: function () {
          // refresh the list
          that.$.filterList.fetch();
          // TODO: Refresh the picker
    ...
    */
    valueChanged: function (inSender, inEvent) {
      // TODO: don't enable the apply button unless
