  ...
  enyo.kind({
    ...
    components: [
      ...
      {kind: "onyx.Drawer", name: "columnsDrawer", open: false, animated: true, components: [
        {kind: "onyx.GroupboxHeader", content: "_columns".loc()},
        {kind: "XV.ToggleButtonWidget", attr: "", label: "_test1".loc()},
        {kind: "XV.ToggleButtonWidget", attr: "", label: "_test2".loc()},
        {kind: "XV.ToggleButtonWidget", attr: "", label: "_test3".loc()},
        {kind: "XV.ToggleButtonWidget", attr: "", label: "_test4".loc()},
        {kind: "XV.ToggleButtonWidget", attr: "", label: "_test5".loc()},
      ]},
    ],
    /**
