  ...
  enyo.kind(enyo.mixin(/** @lends XV.ParameterWidget# */{
    ...
    create: function () {
      ...
      if (this.getShowSaveFilter()) {
        ...
        this.createComponent({kind: "XV.FilterForm", addBefore: null, owner: this});
      ...
      if (this.getShowLayout()) {
        this.createComponent({kind: "XV.LayoutForm", addBefore: null, owner: this});
      }
    },
    ...
    */
    loadItem: function (inSender, inEvent) {
      ...
      // TODO: put this in a separate function that saves that layout/filter
      // together
