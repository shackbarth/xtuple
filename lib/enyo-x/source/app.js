...
(function () {
  ...
  enyo.kind(
    ...
    handleKeyDown: function (inSender, inEvent) {
      ...
      // remember the last 4 key presses
      this._keyBufferArray = this._keyBufferArray.slice(-4);
      if (_.isEqual(this._keyBufferArray, [16, 53, 16, 66])) {
      ...
      //console.log(this._keyBufferArray);
    },
