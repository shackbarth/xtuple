    ...
    startupProcess: function () {
      ...
      // 2: Download extensions
        ...
        for (i = 0; i < XT.session.extensions.length; i++) {
          ...
          // TODO: enforce user-ext permissions

          extensionCount++;
          // the convention for where to find the built js file is something like
          // /core-extensions/builds/crm/crm.js
          ajax = new enyo.Ajax({
            url: "/" + window.location.pathname.split("/")[1] + extensionLocation + "/builds/" + extensionName + "/" + extensionName + ".js",
            handleAs: "text",
