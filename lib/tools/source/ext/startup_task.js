...
(function () {
  ...
  st.prototype.didCompleteCache = function (cache) {
    ...
    if (cache.isAutoSync) {
      ...
      // XXX John alluded to an easier way to get this?
      ...
      // XXX statusChange is a workable proxy for things changing in the collection,
      // but as a binding it gets called more frequently than we need it to, so extra
      // work is being done.
