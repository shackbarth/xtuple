...
(function () {
  ...
  */
  XM.ModelClassMixin = {
    getReportUrl: function (action, modelName, id, printQty, auxilliaryInfo) {
      ...
      if (printQty) {
        //reportUrl = reportUrl + "&printQty=" + printQty;
      }
      if (auxilliaryInfo) {
        reportUrl = reportUrl + "&auxilliaryInfo=" + auxilliaryInfo;
      }
      return reportUrl;
    },
