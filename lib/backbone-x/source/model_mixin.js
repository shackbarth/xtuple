  ...
  XM.ModelMixin = {
    ...
    */
    parse: function (resp) {
      ...
      return parse(this.recordType.suffix(), resp.data);
    },
    ...
    */
    sync: function (method, model, options) {
      ...
      dataSource.request(model, method, payload, options);
  ...
  XM.ModelClassMixin = {
    ...
    */
    canDo: function (action, model) {
      ...
      if (!isGrantedAll && isGrantedPersonal && model && this._cache) {
        i = 0;
