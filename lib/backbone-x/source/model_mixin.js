  ...
  */
  XM.ModelMixin = {
    ...
    */
     ...
     *    'release'
     */
    _lockAction: function (action, options) {
      ...
      this.once(eventName, function () {
        options.success();
        this.lockDidChange(this, _.extend({ }, this.lock));
      }, this);

      this.dispatch("XM.Model", methodName, parameters[action], {
        success: _.bind(this.trigger, eventName),
        error:   _.bind(this.trigger, 'lock:error')
      }, this);
    },
