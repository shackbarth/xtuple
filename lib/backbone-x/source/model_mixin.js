  ...
  */
  XM.ModelMixin = {
    ...
    */
    ...
    /**
     * @private
     * Perform one of three actions on a re-entrant lock: obtain, release,
     *  renew.
     *
     * @param action {String}
     *    'obtain'
     ...
     *    'release'
     */
    _reEntrantLock: function (action, options) {
      var methodName = action + 'Lock',
        ...
        parameters = {
          ...
          release: function () {
            return { key: this.lock.key };
          }.bind(this)
        };

      /**
       * Invoke legacy postconditions.
       */
      ...
      this.dispatch("XM.Model", methodName, parameters[action](), {
        success: _.bind(this.trigger, this, eventName),
        error:   _.bind(this.trigger, this, 'lock:error')
      }, this);
    },
