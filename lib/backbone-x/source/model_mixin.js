  ...
  */
  XM.ModelMixin = {
    ...
    */
     ...
     */
    getLockKey: function () {
      return this.lock ? this.lock.key : null;
    },
    ...
    */
     ...
     */
    _reentrantLockAction: function (action, params, _options) {
      var options = _.extend({ }, _options),
        userCallback = options.success,
        methodName = action + 'Lock',
        eventName = 'lock:' + action;

      this.dispatch("XM.Model", methodName, params, _(options).extend({
        success: _(function (lock) {
          this.lock = lock;
