  ...
  XM.ModelMixin = {
    ...
    */
    sync: function (method, model, options) {
      ...
      switch (method) {
      case "create":
        result = dataSource.requestPost(model, options);
        break;
      case "read":
        result = dataSource.requestGet(model, options);
        break;
      case "update":
        result = dataSource.requestPatch(model, options);
        break;
      case "delete":
        result = dataSource.requestDelete(model, options);
      }
