...
(function () {
  ...
  */
  XM.SimpleModel = Backbone.Model.extend(/** @lends XM.SimpleModel# */{
    ...
    lockDidChange: function (model, lock) {
      ...
      if (lock && lock.key && !this._keyRefresherInterval) {
        ...
        this._keyRefresherInterval = setInterval(function () {
          that.dispatch('XM.SimpleModel', 'renewLock', [lock.key], options);
        }, 25 * 1000);
    ...
    */
    getStatusString: function () {
      var ret = [],
        status = this.getStatus(),
        prop;
      for (prop in XM.SimpleModel) {
        if (XM.SimpleModel.hasOwnProperty(prop)) {
          if (prop.match(/[A-Z_]$/) && XM.SimpleModel[prop] === status) {
            ret.push(prop);
          }
        }
      }
    ...
    */
    validate: function (attributes, options) {
      attributes = attributes || {};
      options = options || {};
      if (options.force || this.getStatus() === XM.SimpleModel.BUSY_FETCHING) {
        return;
      }
      var i,
        result,
  ...
  _.extend(XM.SimpleModel, /** @lends XM.SimpleModel# */{
    ...
    */
    canCreate: function () {
      return XM.SimpleModel.canDo.call(this, 'create');
    },
    ...
    */
    canRead: function (model) {
      return XM.SimpleModel.canDo.call(this, 'read', model);
    },
    ...
    */
    canUpdate: function (model) {
      return XM.SimpleModel.canDo.call(this, 'update', model);
    },
    ...
    */
    canDelete: function (model) {
      return XM.SimpleModel.canDo.call(this, 'delete', model);
    },
  ...
  XM.SimpleModel = XM.SimpleModel.extend({status: XM.SimpleModel.EMPTY});
