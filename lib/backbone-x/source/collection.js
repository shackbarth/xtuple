...
(function () {
  ...
  XM.StaticModel = Backbone.Model.extend({ idAttribute: 'value' });
    ...
    */
    add: function (models, options) {
      ...
      var result = Backbone.Collection.prototype.add.call(this, models, options),
        ...
        // Hack because `add` events don't fire normally when models added here
        // Recursively look for toMany relationships and set sort indexes needed
        // for patch processing
        handleAddRelated = function (model) {
