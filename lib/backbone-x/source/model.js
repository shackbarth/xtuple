...
(function () {
  ...
  /**
   * Simple tuple-space implementation for shared events.
   */
  XM.Tuplespace = new (Backbone.Model.extend())();
  ...
  */
  ...
  XM.Model = XM.Model.extend(/** @lends XM.Model# */{
    ...
    trigger: function () {
      ...
      Backbone.Model.prototype.trigger.apply(XM.Tuplespace, arguments);
    },
