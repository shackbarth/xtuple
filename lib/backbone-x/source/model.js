...
/*global XT:true, XM:true, Backbone:true, _:true, setInterval:true,
  clearInterval:true, jsonpatch:true, Globalize:true*/
...
(function () {
  ...
  */
  ...
  /**
   * Expose _super as a legitimate Backbone property for calling superclass
   * methods without needing to write prototype.<fun>.apply.
   *
   * @augments XM.Model
   * [Inspired by Josh Nielsen]{@link http://forr.st/~4co}
   */
  XM.Model.prototype._super = function (fun) {
    return this.constructor.__super__[fun].apply(this, _.rest(arguments));
  };
  ...
  XM.Model = XM.Model.extend(/** @lends XM.Model# */{
     ...
     * @fires lock:acquire
     */
    acquireLock: _.bind(XM.ModelMixin._lockAction, this, 'acquire'),

    /**
     * Attempt to renew lock.
     * @fires lock:renew
     */
    renewLock: _.bind(XM.ModelMixin._lockAction, this, 'renew'),
    //renewLock:   _.bind(this._lockAction, 'renew'),

    /**
     * Release lock.
     * @fires lock:release
     */
    releaseLock: _.bind(XM.ModelMixin._lockAction, this, 'release'),
    //releaseLock: _.bind(this._lockAction, 'release'),
