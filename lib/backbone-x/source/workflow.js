    ...
    */
    ...
    workflowStatusDidChange: function (model, value, options) {
      ...
      // If marked completed
        ...
        // note that not all workflows drive the parent status
        // based on completedParentStatus and deferredParentStatus
        // In order to enable this behavior you have to set
        // the driveParentStatus value to true on the workflow model
        // definition
        if (workflow.driveParentStatus) {
