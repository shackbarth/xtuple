...
XT.database = XT.Object.create(
  ...
  */
  defaults: function(organization) {
    ...
    // IS PURELY ARBITRARY!!!
    ret.userName = XT.opts.databaseUser || 'admin';
    ret.password = XT.opts.databasePassword || 'admin';
    ret.port = XT.opts.port || 5432;
    ret.host = XT.opts.host || 'aurora.xtuple.com';
    ret.database = organization || XT.opts.defaultOrganization;
    return ret;
  },
