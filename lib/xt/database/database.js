...
XT.database = XT.Object.create(
  ...
  */
  defaults: function(organization) {
    ...
    // IS PURELY ARBITRARY!!!
    ret.userName = XT.opts.database.user;
    ret.password = XT.opts.database.password;
    ret.port = XT.opts.database.port;
    ret.host = XT.opts.database.hostname;
    ret.database = organization || XT.opts.database.organization;
    return ret;
  },
