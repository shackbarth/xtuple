  ...
  handle: function(err) {
    switch(err.type) {
      ...
      case XT.exception.t_report:
        XT.warn("Exception encountered", err);
        break;
      case XT.exception.t_close:
        ...
        delete err.args;
        XT.warn("Exception required closing client connection", err);
        break;
      case XT.exception.t_fatal:
        XT.err("Error encountered", err);
        process.exit();
        break;
      default:
        XT.err("Unrecoverable exception", err);
        break;
    }
  },
