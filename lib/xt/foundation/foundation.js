...
XT.mixin(
  ...
  */
  ...
  cleanup: function cleanup() {
    ...
    // TEMPORARY AS THIS SHOULD ALLOW MODULES TO REGISTER
    // TO BE NOTIFIED DIRECTLY BY THE FRAMEWORK
    XT.log("Shutting down all active servers.");
    if(XT.dataServer) XT.dataServer.close();
    if(XT.orm) XT.orm.get('server').close();
