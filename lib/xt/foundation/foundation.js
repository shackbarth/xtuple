...
XT.mixin(
  ...
  */
  parseConfiguration: function parseConfiguration(f) {
    f = XT.fs.__path__.resolve(XT.basePath, f);
    XT.fs.readFile(f, function(e, d) {
      ...
      // check modelsDir
      XT.fs.exists(XT.opts['generated-models-directory'], function(exists, stats) {
        if(!exists)
      ...
      // check subModelsDir
      XT.fs.exists(XT.opts['generated-subclass-models-directory'], function(exists, stats) {
        if(!exists) {
          // unlike with the generated models directory we try to create this one
          try {
            XT.fs.createDir(XT.opts['generated-subclass-models-directory'], function(err) {
              if(err) throw err;
