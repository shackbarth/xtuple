...
XT.mixin(XT.io,
  ...
  */
  log: function log() {
    ...
    b .set('color', 'grey')
      .set('prefix', '<<LOG>>');
    a.unshift(b);
    flushed = XT.io.__console__.apply(this, a);   
  ...
  */
  warn: function warn() {
    var a = args(),
        b = XT.io.buff();
    var hooks = XT.io._xt_hooks['warn'];
    var flushed;
    var idx = 0;
    var hook;
    b .set('color', 'yellow')
  ...
  */
  debug: function debug() {
    ...
    if(XT.debugging === false) return;

    var a = args(),
        b = XT.io.buff();
    var hooks = XT.io._xt_hooks['debug'];
    var flushed;
    var idx = 0;
    var hook;
    b .set('color', 'blue')
  ...
  */
  report: function report() {
    ...
    b .set('color', 'magenta')
      .set('prefix', null);
    var hooks = XT.io._xt_hooks['report'];
    var flushed;
    var idx = 0;
    var hook;
    ...
    flushed = XT.io.__console__.apply(this, r);
    for (; idx < hooks.length; ++idx) {
      hook = hooks[idx];
      hook(flushed);
    }
