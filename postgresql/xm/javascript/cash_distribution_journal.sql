select xt.install_js('XM','CashDistributionJournal','xtuple', $$
  /* Copyright (c) 1999-2011 by OpenMFG LLC, d/b/a xTuple. 
     See www.xm.ple.com/CPAL for the full text of the software license. */

  XM.CashDistributionJournal = {};
  
  XM.CashDistributionJournal.isDispatchable = true;
  
  /** 
   Post Cash Distribution Journals journal type.
   ...
   *** By Type NOT currently implemented ***
   ...
   @returns {Number}
  */
  XM.CashDistributionJournal.post = function(startDate, endDate, distributionDate) {
    ...
    if(!err) {
      ret = XM.Journal.post('CD',startDate, endDate, distributionDate);
      switch (ret)
      {
        case -4:
