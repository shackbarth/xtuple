...
select private.add_column('orm','orm_namespace', 'text', E'not null');
select private.add_column('orm','orm_type', 'text', 'not null');
...
select private.add_constraint('orm','orm_orm_namespace_orm_type_orm_context', 'unique(orm_namespace, orm_type, orm_context)');
