...
'incident_recurrence', 'public', 'recur',

-- Columns

E'{
  "recur.recur_id as guid",
  "recur.recur_parent_id as incident",
...
create or replace rule \\"_CREATE\\" as on insert to xm.incident_recurrence
  do instead
...
create or replace rule \\"_UPDATE\\" as on update to xm.incident_recurrence
  do instead
...
create or replace rule \\"_DELETE\\" as on delete to xm.incident_recurrence 
  do instead
...
E'{"recur_parent_type = \'INCDT\'"}', 'Incident Recurrence Model', true, true);
