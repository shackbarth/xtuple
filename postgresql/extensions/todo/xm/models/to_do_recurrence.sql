...
'to_do_recurrence', 'public', 'recur',

-- Columns

E'{
  "recur.recur_id as guid",
  "recur.recur_parent_id as to_do",
...
create or replace rule \\"_CREATE\\" as on insert to xm.to_do_recurrence
  do instead
...
create or replace rule \\"_UPDATE\\" as on update to xm.to_do_recurrence
  do instead
...
create or replace rule \\"_DELETE\\" as on delete to xm.to_do_recurrence 
  do instead
...
E'{"recur_parent_type = \'TODO\'"}', 'ToDo Recurrence Model', true, true);
