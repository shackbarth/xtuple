  ...
  enyo.kind({
    ...
    leftColumn: [
      [
        ...
        { name: "name", classes: "account-name", emptyText: "_noJobTitle".loc() }
      ],
      [
        { width: 160 },
    ...
    rightColumn: [
      [
        { width: 320 },
        { name: "primaryContact.name", classes: "cell-italic account-primaryContact-name", emptyText: "_noContact".loc() },
