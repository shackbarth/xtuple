../../jsdoc/jsdoc -l -d ../../jsdoc/out -r ../lib/backbone-x/source
../../jsdoc/jsdoc -l -d ../../jsdoc/out -r ../lib/enyo-x/source/widgets/
../../jsdoc/jsdoc -l -d ../../jsdoc/out -r ../lib/enyo-x/source/views/
