rm -rf ../../jsdoc/out
../../jsdoc/jsdoc -l -d ../../jsdoc/out -r ../lib/backbone-x/source ../lib/tools/source 
#../lib/enyo-x/source/widgets 
#../lib/enyo-x/source/views 

#../enyo-client/application/source ../enyo-client/extensions/source ../node-datasource/routes
