...
XT.CharacteristicAssignment = XT.Record.extend({
  ...
  definition: {
    ...
    sctype: "XT.CharacteristicAssignment",
    ...
    toOne: {
      ...
      characteristic: XT.Record.toOne({
                      self:     "XT.CharacteristicAssignment",
  ...
  xtClass: "XT.CharacteristicAssignment",

});

XT.Store.recordManager.emit("definitionLoaded", XT.CharacteristicAssignment);
