...
select dropIfExists('TRIGGER', 'customer_sync_charroleass_to_char', 'private');
...
create trigger customer_sync_charroleass_to_char after insert or update or delete on private.charroleass for each row execute procedure private.customer_sync_charroleass_to_char();
